...
DoroginVBinImgConvHullOMP::DoroginVBinImgConvHullOMP(const InType &in) : w_(in) {
...
std::size_t DoroginVBinImgConvHullOMP::Index(int col, int row, int width) {
  return (static_cast<std::size_t>(row) * static_cast<std::size_t>(width)) + static_cast<std::size_t>(col);
}

void DoroginVBinImgConvHullOMP::ThresholdImage() {
...
void DoroginVBinImgConvHullOMP::ExploreComponent(int start_col, int start_row, int width, int height,
...
void DoroginVBinImgConvHullOMP::FindComponents() {
...
std::vector<Point> DoroginVBinImgConvHullOMP::BuildHull(const std::vector<Point> &points) {
